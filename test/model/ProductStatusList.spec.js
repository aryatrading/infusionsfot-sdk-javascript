  ...
  describe('(package)', function() {
    describe('ProductStatusList', function() {
      ...
      it('should create an instance of ProductStatusList', function() {
        // TODO: update the code to test ProductStatusList
      ...
      it('should have the property productStatuses (base name: "product_statuses")', function() {
        // TODO: update the code to test the property productStatuses
        expect(instance).to.have.property('productStatuses');
        // expect(instance.productStatuses).to.be(expectedValueLiteral);
      });
