...
Finally, switch to the directory you want to use your infusionsoft_rest_api from, and run:

```shell
npm link /path/to/<JAVASCRIPT_CLIENT_DIR>
```

You should now be able to `require('infusionsoft_rest_api')` in javascript files from the directory you ran the last 
command above from.
...
*InfusionsoftRestApi.ContactApi* | [**loadUsingGET**](docs/ContactApi.md#loadUsingGET) | **GET** /contacts/{contactId} | Retrieve a Contact
...
## Documentation for Models
 ...
 - [InfusionsoftRestApi.CustomFieldOptionItem](docs/CustomFieldOptionItem.md)
