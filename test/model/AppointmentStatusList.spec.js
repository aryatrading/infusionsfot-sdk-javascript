  ...
  describe('(package)', function() {
    describe('AppointmentStatusList', function() {
      ...
      it('should create an instance of AppointmentStatusList', function() {
        // TODO: update the code to test AppointmentStatusList
      ...
      it('should have the property appointmentStatuses (base name: "appointment_statuses")', function() {
        // TODO: update the code to test the property appointmentStatuses
        expect(instance).to.have.property('appointmentStatuses');
        // expect(instance.appointmentStatuses).to.be(expectedValueLiteral);
      });
