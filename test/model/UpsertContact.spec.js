  ...
  describe('(package)', function() {
    describe('UpsertContact', function() {
      ...
      it('should create an instance of UpsertContact', function() {
        // TODO: update the code to test UpsertContact
      ...
      it('should have the property duplicateOption (base name: "duplicate_option")', function() {
        // TODO: update the code to test the property duplicateOption
        expect(instance).to.have.property('duplicateOption');
        // expect(instance.duplicateOption).to.be(expectedValueLiteral);
      });
