  ...
  describe('(package)', function() {
    describe('TaskStatusList', function() {
      ...
      it('should create an instance of TaskStatusList', function() {
        // TODO: update the code to test TaskStatusList
      ...
      it('should have the property taskStatuses (base name: "task_statuses")', function() {
        // TODO: update the code to test the property taskStatuses
        expect(instance).to.have.property('taskStatuses');
        // expect(instance.taskStatuses).to.be(expectedValueLiteral);
      });
